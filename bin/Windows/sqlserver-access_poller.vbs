...
outputfile = "sqlserver_access.out"
If args = 1 Then
...
Function GetAccess(StrSrv)
     ...
     For Each Proc In Item
		 objFile.WriteLine "ForwardedRecordsPerSecond " & Proc.ForwardedRecordsPersec & " " & Time
		 objFile.WriteLine "FullScansPerSecond " & Proc.FullScansPersec & " " & Time
		 objFile.WriteLine "IndexSearchesPerSecond " & Proc.IndexSearchesPersec & " " & Time
		 objFile.WriteLine "PageSplitsPerSecond " & Proc.PageSplitsPersec & " " & Time
		 objFile.WriteLine "WorkfilesCreatedPerSecond " & Proc.WorkfilesCreatedPersec & " " & Time
		 objFile.WriteLine "WorktablesCreatedPerSecond " & Proc.WorktablesCreatedPersec & " " & Time
		 objFile.WriteLine "TableLockEscalationsPerSecond " & Proc.TableLockEscalationsPersec & " " & Time
    Next
End Function
'**************End Query Section***************
