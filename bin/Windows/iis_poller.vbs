...
outputfile = "iis_poller_output.out"
If args = 1 Then
...
Function GetNetwork(StrSrv) 
     ...
     For Each Proc In Item
		 ...
		 objFile.WriteLine "TotalFlushedURIs " & Proc.TotalFlushedURIs & " " & Time
		 objFile.WriteLine "TotalURIsCached " & Proc.TotalURIsCached & " " & Time
		 objFile.WriteLine "URICacheFlushes " & Proc.URICacheFlushes & " " & Time
		 objFile.WriteLine "URICacheHits " & Proc.URICacheHits & " " & Time
		 objFile.WriteLine "URICacheMisses " & Proc.URICacheMisses & " " & Time
    Next
End Function
'**************End Query Section***************