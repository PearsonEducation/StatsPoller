...
outputfile = "udpnetinfo_poller_output.out"
If args = 1 Then
...
Function GetNetwork(StrSrv) 
     ...
     For Each Proc In Item
		objFile.WriteLine "DatagramsNoPort/Second " & Proc.DatagramsNoPortPersec & " " & Time
		objFile.WriteLine "Datagrams/Second " & Proc.Datagramspersec & " " & Time
		objFile.WriteLine "DatagramsReceivedErrors " & Proc.DatagramsReceivedErrors & " " & Time
		objFile.WriteLine "DatagramsReceived/Second " & Proc.DatagramsReceivedPersec & " " & Time
		objFile.WriteLine "DatagramsSent/Second " & Proc.DatagramsSentPersec & " " & Time
    Next
End Function
'**************End Query Section***************