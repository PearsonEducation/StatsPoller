...
outputfile = "windows_udpnetinfo.out"
If args = 1 Then
...
Function GetNetwork(StrSrv)
      ...
      strQuery = "select * from Win32_PerfFormattedData_Tcpip_UDPv4"
     ...
     For Each Proc In Item
		objFile.WriteLine "DatagramsNoPortPerSecond " & Proc.DatagramsNoPortPersec & " " & Time
		objFile.WriteLine "DatagramsPerSecond " & Proc.Datagramspersec & " " & Time
		objFile.WriteLine "DatagramsReceivedErrors " & Proc.DatagramsReceivedErrors & " " & Time
		objFile.WriteLine "DatagramsReceivedPerSecond " & Proc.DatagramsReceivedPersec & " " & Time
		objFile.WriteLine "DatagramsSentPerSecond " & Proc.DatagramsSentPersec & " " & Time
    Next
End Function
'**************End Query Section***************
