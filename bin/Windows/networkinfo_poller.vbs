...
Function GetNetwork(StrSrv)
      ...
      strQuery = "select * from Win32_PerfFormattedData_PerfNet_Server"
     ...
     For Each Proc In Item
		 objFile.WriteLine "ReceivedBytesPerSecond " & Proc.BytesReceivedPerSec & " " & Time
		 objFile.WriteLine "TransmittedBytesPerSecond " & Proc.BytesTransmittedPerSec & " " & Time
		 objFile.WriteLine "ReceivedMBitsPerSecond " & ((Proc.BytesReceivedPerSec / 1000000) / 8) & " " & Time
		 objFile.WriteLine "TransmittedMbitsPerSecond " & ((Proc.BytesTransmittedPerSec / 1000000) / 8) & " " & Time
    Next
End Function
'**************End Query Section***************
