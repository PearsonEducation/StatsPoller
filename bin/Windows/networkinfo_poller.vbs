...
Function GetNetwork(StrSrv) 
     ...
     For Each Proc In Item
		 objFile.WriteLine "ReceivedBytes/Second " & Proc.BytesReceivedPerSec & " " & Time
		 objFile.WriteLine "TransmittedBytes/Second " & Proc.BytesTransmittedPerSec & " " & Time
		 objFile.WriteLine "ReceivedMBits/Second " & ((Proc.BytesReceivedPerSec / 1000000) / 8) & " " & Time
		 objFile.WriteLine "TransmittedMbits/Second " & ((Proc.BytesTransmittedPerSec / 1000000) / 8) & " " & Time
    Next
End Function
'**************End Query Section***************