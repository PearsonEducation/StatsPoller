...
import com.pearson.statspoller.utilities.web_utils.HttpUtils;
...
import com.pearson.statspoller.metric_formats.SendMetricsToOutputModuleThread;
    ...
    */
    protected static String createInfluxdbUrl(InfluxdbMetric_v1 influxdbMetric, String baseUrl) {
        ...
        if ((influxdbMetric.getUsername() != null) || (influxdbMetric.getPassword() != null) || 
                (influxdbMetric.getTimePrecisionCode() != com.pearson.statspoller.metric_formats.influxdb.Common.TIMESTAMP_PRECISION_UNKNOWN)) {
            influxdbUrl.append("?");
        }
        ...
        if (influxdbMetric.getTimePrecisionCode() != com.pearson.statspoller.metric_formats.influxdb.Common.TIMESTAMP_PRECISION_UNKNOWN) {
